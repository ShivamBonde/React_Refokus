...
function Navbar() {
  return (
    <div className="max-w-screen-lg  flex items-center justify-between border-b-[1px] border-zinc-500 mx-auto py-4">
        ...
        <div className="Links  ml-16 flex gap-12">
          {["Home", "Work", "Culture", "", "News"].map((elem, index) =>
            elem.length === 0 ? (
              ...
              <a
                href="#" key={index}
                className="font-light text-sm flex items-center gap-1"
              >
                {index == 1 && (
                  <span key={index}
